...
data class Base(val coord: Coord?, val weather: List<Weather298664977>?, val base: String?, val main: Main?, val visibility: Number?, val wind: Wind?, val clouds: Clouds?, val dt: Number?, val sys: Sys?, val timezone: Number?, val id: Number?, val name: String?, val cod: Number?)
...
data class Weather298664977(val id: Number?, val main: String?, val description: String?, val icon: String?)
